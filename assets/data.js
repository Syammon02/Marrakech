...
/* Photos : slug d'article Wikipédia (FR sauf préfixe en:).
   L'app tente de charger la vignette via l'API REST de Wikipédia et la met en cache.
   Si le réseau est coupé ou l'article sans image, on retombe sur le visuel zellige généré. */
export const WIKI = {
  ...
  maisonphoto:"Marrakech",
  majorelle:"Jardin_Majorelle",
  ysl:"Musée_Yves_Saint_Laurent_de_Marrakech",
  jardinsecret:"Riad_(architecture)",
  menara:"Ménara_(Marrakech)",
  cyberpark:"Marrakech",
  palmeraie:"Palmeraie_de_Marrakech",
  souks:"Souk",
  rahba:"Souk",
  soukelkhemis:"Marché_aux_puces",
  "33rueMajorelle":"Artisanat_marocain",
  ensemble:"Artisanat_marocain",
  nomad:"Cuisine_marocaine",
  lejardin:"Riad_(architecture)",
  terrasseepices:"Cuisine_marocaine",
  daryacout:"Cuisine_marocaine",
  foundouk:"Fondouk",
  alfassia:"Pastilla",
  amal:"Couscous",
  latrattoria:"Cuisine_italienne",
  plus61:"Cuisine_méditerranéenne",
  mechoui:"Méchoui",
  cafeclock:"Marrakech",
  naranj:"Cuisine_libanaise",
  salama:"Place_Jemaa_el-Fna",
  pepenero:"Riad_(architecture)",
  beldi:"Rose_de_Damas",
  bacha:"Café",
  cafeepices:"Épice",
  grandcafeposte:"Guéliz",
  cafearabe:"Thé_à_la_menthe",
  lmida:"Marrakech",
  "16cafe":"Guéliz",
  elfenn:"Marrakech",
  kabana:"Koutoubia",
  ...
  quad:"Palmeraie_de_Marrakech",
  nikki:"Piscine",
  golfamelkis:"Golf",
  agafay:"Désert_d'Agafay",
  ourika:"Ourika",
  anima:"Jardin_botanique",
